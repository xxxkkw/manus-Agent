...
from app.tool.MVF_Detect import MVF_Detect
from app.tool.TSA_Detect import TSA_Detect
...
class Manus(BrowserAgent):
    ...
    available_tools: ToolCollection = Field(
        default_factory=lambda: ToolCollection(
            PythonExecute(), BrowserUseTool(), StrReplaceEditor(), Terminate(), MVF_Detect(), TSA_Detect()
        )
    )

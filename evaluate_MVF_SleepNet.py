...
parser.add_argument("-c", type=str, default="./config/config.config",help="configuration file", required=False)
parser.add_argument("-g", type=str, default="0",help="GPU number to use, set '-1' to use CPU", required=False)
